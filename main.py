...
def calculate():
    ...
    for n in range(number_of_iterations - 1):
        ...
        runge_kutta_total = perform_runge_kutta(current_angular_momentum, principle_moment, time_step)
...
def perform_runge_kutta(current_angular_momentum, principle_moment, time_step):
    ...
    runge_kutta4 = runge_kutta_four(current_angular_momentum, principle_moment, runge_kutta3, time_step)

    runge_kutta_total = Vector()

    runge_kutta_total.elements = ((1.0 / 6.0)
                                  * (runge_kutta1.elements
...
def runge_kutta_four(current_angular_momentum, principle_moment, runge_kutta3, time_step):
    runge_kutta4 = Vector()
